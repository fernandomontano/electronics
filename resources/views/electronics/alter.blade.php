...
@section('content')
    ...
    <form action="{{ route('update', $electronic->id) }}" method="post" enctype="multipart/form-data"
        ...
        <div class="bg-base-content/10 rounded-xl p-4">
            <div class="rounded-xl gap-3 px-2 text-primary flex flex-col justify-center items-center">
                ...
                <div class="flex text-center gap-2 my-3 items-center justify-center w-full">
                    ...
                    <select name="category" value="{{ $electronic->name }}"
                    ...
                    <select name="brand" value="{{ $electronic->name }}"
                        class="bg-neutral text-white p-2 rounded placeholder-white w-full">
                ...
                <div class="flex flex-wrap justify-around items-center gap-10">
                    <div class="flex">
                        ...
                        <select name="offers" value="{{ $electronic->name }}"
